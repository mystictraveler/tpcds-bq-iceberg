...
FROM (
  SELECT 'store channel' AS channel, CONCAT('store', store_id) AS id, sales, returns_amt, profit FROM ssr
  UNION ALL
  SELECT 'catalog channel' AS channel, CONCAT('catalog_page', catalog_page_id) AS id, sales, returns_amt, profit FROM csr
  UNION ALL
  SELECT 'web channel' AS channel, CONCAT('web_site', web_site_id) AS id, sales, returns_amt, profit FROM wsr
) x
